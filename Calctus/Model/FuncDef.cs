...
namespace Shapoco.Calctus.Model {
    class FuncDef {
        ...
        public static readonly FuncDef exp = new FuncDef("exp", (e, a) => new RealVal(Math.Exp(a[0].AsDouble)));
        ...
        public static readonly FuncDef abs = new FuncDef("abs", (e, a) => new RealVal(Math.Abs(a[0].AsDouble)));
